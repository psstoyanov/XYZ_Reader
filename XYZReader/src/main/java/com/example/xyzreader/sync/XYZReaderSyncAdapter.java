...
public class XYZReaderSyncAdapter extends AbstractThreadedSyncAdapter
{
    public final String LOG_TAG = XYZReaderSyncAdapter.class.getSimpleName();
    ...
    public XYZReaderSyncAdapter(Context context, boolean autoInitialize) {
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        XYZReaderSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
